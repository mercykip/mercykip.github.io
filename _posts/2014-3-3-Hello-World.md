...
## Generating an APK for cordova Project
   ...
   Generate a keystore  
   Syntax    
   edit everything enclosed in italic/bolds
   keytool -genkey -v -keystore **<keystoreName>**__.keystore -alias _<Keystore AliasName>_**** -keyalg **<Key algorithm>**__ -keysize     **<Key size>**__ -validity **<Key Validity in Days>**__  
  eg.  
